...
def build_system():
    """Build the complete ShopSmart support system. Returns (graph, memory, store, data, known_names)."""
    load_env()
    ...
    return graph, memory, store, data, known_names, langfuse_handler
...
def main():
    ...
    graph, memory, store, data, known_names, langfuse_handler = build_system()
