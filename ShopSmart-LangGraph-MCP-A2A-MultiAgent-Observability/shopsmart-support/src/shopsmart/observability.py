"""Observability bootstrap — LangSmith and Langfuse (enabled by default)."""
...
def setup_langsmith() -> bool:
    ...
    os.environ.setdefault("LANGSMITH_PROJECT", "shopsmart-support")
...
def setup_langfuse():
    ...
    Returns (handler_or_None, is_active).
    """
