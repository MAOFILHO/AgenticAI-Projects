...
tab_chat, tab_manager, tab_dashboard, tab_observability = st.tabs([
    "💬 Chat", "👤 Manager Review", "📊 Dashboard", "🔍 Observability"
])
    ...
    if prompt := st.chat_input("Enter your support request...", disabled=not st.session_state.system_ready):
        ...
        with st.chat_message("assistant"):
            with st.spinner("Processing your request..."):
                graph, memory, store, data, known_names, lf_handler = st.session_state.system
