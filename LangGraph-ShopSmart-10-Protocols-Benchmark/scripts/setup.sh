...
echo "  4. Start protocol servers:   make protocols-up   (REST/GraphQL/gRPC/Webhook/WebSocket/SOAP)"
echo "  5. Start brokers+responders: make brokers-up && make responders-up   (MQTT/AMQP)"
echo "  6. Run the benchmark:        make benchmark"
echo "  7. Start the app:            make app"
echo
