...
> ℹ️ If the repo is private, you'll need a [GitHub Personal Access Token](https://github.com/settings/tokens) and use the URL form `https://<TOKEN>@github.com/MAOFILHO<img width="862" height="101" alt="Screenshot 2026-05-31 at 6 17 11 PM" src="https://github.com/user-attachments/assets/5fed489d-6b72-45f4-83e0-4d6eae928e77" />
/SecureLife-MCP-Project.git`.
...
<img width="862" height="101" alt="Screenshot 2026-05-31 at 6 17 11 PM" src="https://github.com/user-attachments/assets/6a35e078-ee35-4afb-a1a1-c21135e543b3" />
...
```bash
cat ~/SecureLife-MCP-Project/securelife_client_app/.env
```
...
<img width="713" height="165" alt="Screenshot 2026-05-31 at 6 30 20 PM" src="https://github.com/user-attachments/assets/cfd822ee-f1e6-4491-a130-6de876fa713d" />
...
PYTHONPATH=. chainlit run securelife_client_app/app.py --host 0.0.0.0 --port 8000
```

**Expected output:** `Your app is available at http://127.0.0.1:8000` (no traceback).

<img width="948" height="253" alt="Screenshot 2026-05-30 at 11 05 10 PM" src="https://github.com/user-attachments/assets/62ad8764-f0a3-4f23-adf8-76188f2c0c4a" />
...
[Service]
User=ubuntu
WorkingDirectory=/home/ubuntu/SecureLife-MCP-Project
Environment=PYTHONPATH=/home/ubuntu/SecureLife-MCP-Project
ExecStart=/home/ubuntu/SecureLife-MCP-Project/.venv/bin/python securelife_mcp_server/server.py
Restart=always
RestartSec=5
...
WorkingDirectory=/home/ubuntu/SecureLife-MCP-Project
Environment=PYTHONPATH=/home/ubuntu/SecureLife-MCP-Project
ExecStart=/home/ubuntu/SecureLife-MCP-Project/.venv/bin/chainlit run securelife_client_app/app.py --host 127.0.0.1 --port 8000
Restart=always
RestartSec=5
StandardOutput=journal
StandardError=journal
...
Open Safari, Chrome, or your favourite browser on your Mac and navigate to your **EC2 Public IPv4 address** (the plain IP, not the DNS):
